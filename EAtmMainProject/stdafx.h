...
#define WM_USER_WRITE WM_USER + 1
...
//#import "D:\\Program Files\\Microsoft Office\\Office14\\EXCEL.EXE" \
...
#import ".\\excel\\MSO.DLL" \
	rename("RGB", "MSORGB") \
	rename("DocumentProperties", "MSODocumentProperties")
using namespace Office;
#import ".\\excel\\VBE6EXT.OLB"

using namespace VBIDE;
#import ".\\excel\\EXCEL.EXE" \
	rename("DialogBox", "ExcelDialogBox") \
	rename("RGB", "ExcelRGB") \
	rename("CopyFile", "ExcelCopyFile") \
	rename("ReplaceText", "ExcelReplaceText") \
